...
namespace TaskManagementSystem.Persistence.Services;
public class AuthService : IAuthService
{
    ...
    public AuthService(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IMapper mapper, IConfiguration configuration, TaskManagementDbContext context)
    {
